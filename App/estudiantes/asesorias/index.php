<?php 
	...
	$query = "SELECT  
			...
			WHERE (ea.FK_asesoria IS NULL) AND (a.FK_alumno = ".$_SESSION['idEstudiante'].")";
	...
	$query = "SELECT  
			...
			WHERE ea.val_tipo = 2 AND a.FK_alumno = ".$_SESSION['idEstudiante'];
			// WHERE ea.val_tipo = 2";
	...
	<?php else: ?>
		<div id="asesorias">
			...
			<?php foreach( $asesorias as $a ): ?>
				<div class="item-asesoria" style="padding: 10px; border: 1px solid black; display: inline-block; width: 500px;">
					<p class="alumno-asesoria"> <?= $a['alumno'] ?> </p>
		...
		<div id="asesorias-canceladas">
			...
			<?php foreach( $canceladas as $c ): ?>
				<div class="item-asesoria" style="padding: 10px; border: 1px solid black; display: inline-block; width: 500px;">
					<p class="alumno-asesoria"> <?= $c['alumno'] ?> </p>
